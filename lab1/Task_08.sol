...
contract Task_08 {
   ...
   function getDynamicByteArrayElement(bytes memory _byteArray, uint256 _index) public pure returns (bytes1) {
       require(_index < _byteArray.length, "Index out of bounds");
